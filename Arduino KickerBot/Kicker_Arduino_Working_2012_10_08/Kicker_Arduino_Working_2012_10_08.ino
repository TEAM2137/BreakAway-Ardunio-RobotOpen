...
void enabled() {
  ...
  // ===============================================================  
  if (JoyBtn3Toggle == HIGH) {
    RobotOpen.setPWM(SIDECAR_PWM5, 227); // 203=0.6 in labview, Austin Tai said that was what they used. This # has been changed because it seemed too slow. THIS CHANGE IS UNTESTED!!!!! 
    // digitalWrite(SIDECAR_DIGITAL5, HIGH); // used digital 5 for debug  
  }
  else
  {
